...
export function LandingDemoModal({ isOpen, onClose }: DemoModalProps) {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-slate-950/70 backdrop-blur-sm animate-in fade-in duration-150"
      onClick={(e) => {
    ...
    >
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-lg rounded-2xl bg-white border border-slate-200 shadow-2xl overflow-hidden z-10 my-8 animate-in zoom-in-95 duration-200"
      >
        {/* Top header bar */}
